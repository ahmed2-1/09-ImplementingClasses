...
# TO_DO (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
# TO_DO (continued): Then implement a class called   Point that has NO METHODS
# TO_DO (continued)  yet, just the lines that start the definition of any class:
#
...
class Point (object):
    ...
    def move_to(self, x, y):
        ...
        distance = self.get_distance_from(p_i)
    ...
    def get_distance_from_start(self):
        p0 = Point(self.x1, self.y1)
        ds = self.get_distance_from(p0)
        return ds
    ...
    def halfway_to(self, p2):
        x_final = (self.x+p2.x)/2
        y_final = (self.y+p2.y)/2
        new_point = Point(x_final, y_final)
        return new_point
...
def run_test_get_number_of_moves_made():
    ...
    # TO_DO (continued):  HINT: What must a Point REMEMBER for this method?
    # --------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
